    ...
    plot_true_positives(
        {
            ...
            "macs reads remapped without control": "../tests/ctcf_macs_reads_without_control_sequences.fasta",
            #"macs": "CTCFpFix.fasta",
            ...
            "graph without control": "../tests/laststep_sequences.fasta",
            # "graph with control": "../tests/ctcf_q30_with_control_sequences.fasta",
