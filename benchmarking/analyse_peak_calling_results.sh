...
fimo --qv-thresh --thresh 0.1  --max-stored-scores 5000000  -oc fimo_peaks_to_linear_sequences motif.meme peaks_to_linear_sequences.fasta
...
do
    ...
    fimo --qv-thresh --thresh 0.1  --max-stored-scores 5000000  -oc fimo_macs_chr$chromosome motif.meme macs_sequences_chr${chromosome}_summits.fasta
    fimo --qv-thresh --thresh 0.1  --max-stored-scores 5000000  -oc fimo_graph_chr$chromosome motif.meme ${chromosome}_sequences_summits.fasta
done
...
do
    ...
    fimo --qv-thresh --thresh 0.1  --max-stored-scores 5000000  -oc fimo_macs_unique_chr$chromosome motif.meme macs_sequences_chr${chromosome}_summits_unique.fasta
    fimo --qv-thresh --thresh 0.1  --max-stored-scores 5000000  -oc fimo_graph_unique_chr$chromosome motif.meme ${chromosome}_sequences_summits_unique.fasta
done
...
fimo --qv-thresh --thresh 0.1  --max-stored-scores 5000000  -oc unique_graph motif.meme unique_graph.fasta
fimo --qv-thresh --thresh 0.1  --max-stored-scores 5000000  -oc unique_macs motif.meme unique_macs.fasta
