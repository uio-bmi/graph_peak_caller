...
out_file=$4
tf=$5
background_model_file=$6

echo "Using background model file $background_model_file"
...
graph_peak_caller plot_motif_enrichment $fasta1 $fasta2 motif.meme $out_file True $tf $background_model_file
