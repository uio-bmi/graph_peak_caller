...
# Call peaks
graph_peak_caller callpeaks graph.nobg haplo1kg50-mhc.vg linear_map reads.json reads.json False sparsetest_ 135 36

# Run fimo
fimo -oc fimo_sparsetest_sequences MA0139.1.meme sparsetest_sequences.fasta
fimo -oc fimo_macs_sequences MA0139.1.meme macs_sequences_mhc.fasta

# Motif enrichment
graph_peak_caller plot_motif_enrichment sparsetest_sequences.fasta macs_sequences_mhc.fasta MA0139.1.meme plot.png True
