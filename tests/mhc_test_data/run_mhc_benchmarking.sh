...
#graph_peak_caller analyse_peaks graph.obg haplo1kg50-mhc.json macs_sequences_chr6.fasta test_sequences.fasta fimo_macs_sequences/fimo.txt fimo_test_sequences/fimo.txt
