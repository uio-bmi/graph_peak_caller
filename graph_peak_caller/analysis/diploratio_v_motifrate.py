...
def plot(base_name):
    ...
    motif = np.load(base_name + "/summits_alignments_motif_summary.npz")
    nonmotif = np.load(base_name + "/summits_alignments_nonmotif_summary.npz")
    ...
    plt.plot(np.linspace(0, 1, 20), ratio, label=base_name)
